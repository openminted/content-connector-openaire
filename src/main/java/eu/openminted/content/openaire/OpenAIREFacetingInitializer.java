...
public class OpenAIREFacetingInitializer {
    ...
    private String RESULT_LANG_NAME = "resultlanguagename";
    ...
    public OpenAIREFacetingInitializer() {
        ...
        OmtdOpenAIREMap.put(OMTDFacetEnum.DOCUMENT_LANG.value(), RESULT_LANG_NAME);
        ...
        OmtdOpenAIREMap.put(RESULT_LANG_NAME, OMTDFacetEnum.DOCUMENT_LANG.value());
    }
